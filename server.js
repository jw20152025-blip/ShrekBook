    ...
    try {
        ...
        for (const house of data || []) {
            ...
            houses.push({
                ...house,
                house_type_name:
                    house.house_types?.name || "Unknown",
...
// SEARCH USERS FOR HOUSE INVITES
...
app.post("/api/houses/:id/invite", async (req, res) => {
    try {
        ...
        // Check inviter is owner/admin/member
        const {
            data: inviter
        } = await supabase
            .from("house_members")
