...
app.post("/api/login", async (req, res) => {
    ...
    try {
        ...
        // Get profile
        // IMPORTANT:
        // We do NOT request cat/gyatt/ogred
        // because reactions now live in reactions.
...
app.get(
    ...
    async (req, res) => {
        ...
        try {
            ...
            // Add reaction counts separately
